...
class VideoProfanityDetection:
    def __init__(self, input_video:str, custom_words:list = [], mask_char:str = "🤬"):
    ...
    def extract_audio(self, input_video:str) -> str:
        ...
        try:
            ...
            audio_output_path = f"storage/audio/{str(int(time.time()))}.mp3"  # Generate output path
    ...
    def video_moderation (self, blur_video:bool):
        ...
        moderated_audio_output_path, text_profanity_data = self.audio.audioProfanityFilteration(
        ...
        final_moderated_output = self.blur_and_audio(blur_seconds=seconds_to_blur, audio_path=moderated_audio_output_path)
